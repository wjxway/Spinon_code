...
namespace IR
{
     ...
     */
    bool Generate_RMT_item(rmt_item32_t *pointer, const uint32_t data) noexcept;
     ...
     */
    bool IRAM_ATTR Parse_RMT_item(volatile rmt_item32_t *pointer, uint32_t *dataptr) noexcept;
    }
}
