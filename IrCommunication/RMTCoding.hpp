...
namespace IR
{
     ...
     *
     * @note Please manually edit the generated rmt_item32_t[] object to control the initial delay and final pulse length.
     *       The default delay is 1 tick and default final pulse length is RMT_ticks_num.
     *       Usually, for synchronization and distinguishing between the upper and lower emitter,
     *       the lower emitter can directly use the generated data, but the upper emitter should change the pointer[0].duration0 to 2
     *       and pointer[RMT_data_pulse_count].duration1 to 2*RMT_ticks_num
     */
    bool Generate_RMT_item(rmt_item32_t *pointer, const uint32_t data);
